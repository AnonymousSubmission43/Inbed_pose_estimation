...
if __name__ == '__main__':
    dataset_path = '/media/yuyin/10THD1/Dataset/pose/mpi_inf_3dhp'
    out_path = '/media/yuyin/10THD1/Dataset/pose/mpi_inf_3dhp/extra'
    openpose_path = ''
    ...
    train_data(dataset_path, openpose_path, out_path, 
                   joints_idx, scaleFactor, extract_img=True, fits_3d=None)
