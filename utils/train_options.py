...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument('--model', type=str, default='hmr', help='hmr, mulhmr, featcat')
        train.add_argument('--data_train', type=str, default='slp-4mod-train', help='slp, slp-rgb, slp-ir')
        train.add_argument('--data_test', default='slp-4mod-uncover+slp-4mod-cover1+slp-4mod-cover2', help="'slp-rgb-uncover', 'h36m','h36m-p1', 'h36m-p2', 'lsp', '3dpw', 'mpi-inf-3dhp'")
        ...
        train.add_argument('--summary_steps', type=int, default=25, help='Summary saving frequency')
        train.add_argument('--test_steps', type=int, default=2e5, help='Testing frequency during training')
        train.add_argument('--checkpoint_steps', type=int, default=2e5, help='Checkpoint saving frequency')
        ...
        train.add_argument('--rot_factor', type=float, default=15, help='Random rotation in the range [-rot_factor, rot_factor]') 
        ...
        train.add_argument('--scale_factor', type=float, default=0.15, help='Rescale bounding boxes by a factor of [1-scale_factor,1+scale_factor]') 
        ...
        train.add_argument('--no_render', default=False, action='store_true', help='Render results during training') 
        train.add_argument('--num_cas_iters', default=2, type=int, help='Number of cascade iterations') 
        train.add_argument('--mod1_epoch', default=50, type=int, help='stop epoch for mode 1 of bodies_at_rest') 
