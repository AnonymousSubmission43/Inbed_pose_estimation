...
class CheckpointSaver():
    ...
    def save_checkpoint(self, models, optimizers, epoch, batch_idx, batch_size, dataset_perm, total_step_count):
        ...
        checkpoint_filename = os.path.abspath(os.path.join(self.save_dir, 'epoch_' + str(epoch) + '_' + str(batch_idx) + '.pt'))
        checkpoint = {}
        for model in models:
    ...
    def get_latest_checkpoint(self):
        ...
        checkpoint_list = sorted(checkpoint_list, key=lambda c_list: int(c_list.split('_')[-2]))
