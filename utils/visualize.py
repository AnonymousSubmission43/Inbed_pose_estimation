...
class Debugger(object):
  ...
  def add_point_3d(self, points, c='b', marker='o', edges=None):
    ...
    self.ax.scatter(x, y, z, s = 100, c = c, marker = marker)
    self.ax.scatter(x[16], y[16], z[16], s = 100, c='g',marker='^')
    self.ax.scatter(x[17], y[17], z[17], s = 100, c='y',marker='^')
    self.ax.scatter(x[18], y[18], z[18], s = 100, c='r',marker='^')
    # iind=6
    # self.ax.scatter(x[iind], y[iind], z[iind], s = 120, c='r',marker=marker)
